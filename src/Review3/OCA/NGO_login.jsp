<link rel="stylesheet" href="style1.css" media="screen" />
	   ...
	   <body background="child1/4.jpg"><center><font color="cyan"><h3>NGO LOGIN PAGE</h3></font>
	          <form name="Form1" action="NGO_login1.jsp" onSubmit="return validate()">
			  <table>
			  <tr><td>username: <input type="text" name=username></tr></td>
			  <tr><td>password:<input type="password" name=password ></tr></td>
<tr><td>
<input type="submit" name="submit" value="Submit">
<a href="Registration.jsp" target="middle"><font color="red"><h3><b>signup</b></h3></font>
</td></tr>
</center>
</table>
</form>
